...
public:
    ...
    void insert(Employee* data)
    {
        ...
        for (int i = 0; i < (random_height); i++)
        {
            ...
            {
                if (temp->get_next()->get_data()->get_id() == 9999999)
                {
                    break;
                }
                else
    ...
    bool search(int search_id, QSL_Node *(&test_emp))
    {
