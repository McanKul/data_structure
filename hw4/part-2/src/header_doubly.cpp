...
private:
   DSL_Node *start;
   DSL_Node *end;//end eklemek istedim
   int height;
   int height_for_random;//randomu yüksekliği burada tutmak daha verimli geldi her skop için tekrardan oluşturmaktansa
...
public:
   ...
   void insert(Employee *data)
   {
      ...
      if ((random == 1) && (this->height_for_random < this->height))//%50 ihtimalle randomu arttırıyor
      {
